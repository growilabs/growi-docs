<template>
  <div class="container px-4 mt-5">
    ...
    <PageLinks :categoryName="this.$themeLocaleConfig.category.about_growi_app" :pageItems="getPageItems(['tutorial', 'examples', 'how-to-use', 'management-settings', 'upgrade-guide'])" />
  </div>
</template>
