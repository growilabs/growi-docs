          ...
          '/ja/admin-guide/': [
            ...
            },
            {
              ...
              children: [
                ...
                '/ja/admin-guide/management-cookbook/grw-official-bot-settings.md',
                '/ja/admin-guide/management-cookbook/grw-custom-bot-without-proxy-settings.md',
                '/ja/admin-guide/management-cookbook/grw-custom-bot-with-proxy-settings.md',
