...
## アンケート設定
アンケートを有効にすることで、GROWI 開発チームからアンケートを受け取り回答することができます。
...
ただし、`growiInfo.appSiteUrl` プロパティは `サイト URL を匿名化して送信する` オプションを有効にすることで送信されなくなります。このオプションを有効にすることでアンケート回答データの送信元である GROWI アプリケーションが特定されなくなります。
