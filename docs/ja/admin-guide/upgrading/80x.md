...
エージェント駆動 GROWI AI では、利用する LLM プロバイダを OpenAI / Anthropic / Google / Azure OpenAI から選択できます。設定方法は [GROWI AI Agent のセットアップと管理](/ja/admin-guide/management-cookbook/growi-ai-agent.html) を参照してください。
