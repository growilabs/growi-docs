...
UTCP Code-Mode を経由して GROWI MCP に接続することで、[AI ツール（スキル）](/ja/guide/features/ai-tools.html)を利用できるようになります。
...
環境変数（`GROWI_API_TOKEN_1` など）の説明は、上記の「MCPの設定方法」セクションを参照してください。複数の GROWI インスタンスを使用する場合も同様に `_2`, `_3` ... と番号を変えて追加します。
