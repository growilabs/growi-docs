...
### 古いバージョンから最新バージョンへ更新する場合

- 特定バージョンで固定していた場合など、古いバージョンから最新バージョンへ一気に更新するときは、更新の前後にお客様側での対応が必要になる項目があります。
- 対応が必要な項目は、[アップグレードの概要と最新バージョンへの移行](/ja/admin-guide/upgrading/#a-growi-cloud-をご利用中の場合) の「A. GROWI.cloud をご利用中の場合」にまとめてあります。
