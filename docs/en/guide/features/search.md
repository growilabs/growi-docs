...
:::warning
To use this function, setting up Elasticsearch as a search-engine database is required. Check [this](../../admin-guide/management-cookbook/setup-search-system.md) page to find out how.
:::
