...
| `S3_LIFETIME_SEC_FOR_TEMPORARY_URL` | time to keep the cache of signed URLs (number of seconds
) | 120 |
...
| `GCS_LIFETIME_SEC_FOR_TEMPORARY_URL` | time to keep the cache of signed URLs (number of seconds
)| 120|
