...
::: warning
If your upgrade passes through v6.1.0–v7.0.15, do not keep operating on a version in that range. Those versions have a Revision data migration bug.
For details, see [Upgrade Overview and Migration to the Latest Version](/en/admin-guide/upgrading/#versions-to-avoid-stopping-on).
:::
