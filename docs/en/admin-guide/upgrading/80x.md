...
::: warning
The legacy AI integration settings have been removed and the configuration method has been overhauled. If you use the AI integration features, they will not work as-is after the upgrade and reconfiguration is required. For the configuration steps, see [Setting up and managing GROWI AI Agent](/en/admin-guide/management-cookbook/growi-ai-agent.html).
:::
...
In addition, in the AI chat input field you can now type `@` followed by text to search for pages and pass a selected page to the AI as context. For usage, see [GROWI AI Agent](/en/guide/features/growi-ai-agent.html).

<ContextualBlock context="docs-growi-org">

With GROWI AI Agent, you can choose the LLM provider from OpenAI / Anthropic / Google / Azure OpenAI. For configuration, see [Setting up and managing GROWI AI Agent](/en/admin-guide/management-cookbook/growi-ai-agent.html).
...
- [x] Do you run Elasticsearch v7? (If so, migrate to v8 or v9 before upgrading.)
