...
::: tip
For the overall flow of upgrading to a newer version, and which versions to avoid stopping on, see [Upgrade Overview and Migration to v7](/en/admin-guide/upgrading/).
:::
