...
In v5.0, a page tree view has been added to the sidebar. It will allow you to view the hierarchical structure of all pages.
Along with that, there is a big change in the specifications of handling descendant pages when moving, renaming, and deleting pages.
...
We also recommend you to read [What to Check Before Upgrading](#what-to-check-before-upgrading).
...
For more information about Administrator's Guide, please see [Environment Variables](/ja/admin-guide/admin-cookbook/env-vars.html).
...
Specifically, the following icons which were first placed at the top of the table of contents, have moved into the three-point reader dropdown.
...
**Before**
![v4-history-attachment-sharelink](../../../en/admin-guide/upgrading/images/v4-history-attachment-sharelink.png)

**After**  
![v5-history-attachment-sharelink](../../../en/admin-guide/upgrading/images/v5-history-attachment-sharelink.png)
...
**Before**  
![v4-history-attachment-sharelink](../../../en/admin-guide/upgrading/images/v4-timeline.png)

After  
![v4-history-attachment-sharelink](../../../en/admin-guide/upgrading/images/v5-timeline.png)
...
**Before**  
![v4-footprints-comments](../../../en/admin-guide/upgrading/images/v4-footprints-comments.png)

**After**  
![v5-footprints-comments](../../../en/admin-guide/upgrading/images/v5-footprints-comments.png)
