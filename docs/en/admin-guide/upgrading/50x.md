...
**Before**
![v4-history-attachment-sharelink](./images/v4-history-attachment-sharelink.png)

**After**  
![v5-history-attachment-sharelink](./images/v5-history-attachment-sharelink.png)
...
**Before**  
![v4-history-attachment-sharelink](./images/v4-timeline.png)

After  
![v4-history-attachment-sharelink](./images/v5-timeline.png)
...
**Before**  
![v4-footprints-comments](./images/v4-footprints-comments.png)

**After**  
![v5-footprints-comments](./images/v5-footprints-comments.png)
