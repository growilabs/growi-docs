...
- [x] You are using the deprecated nocdn version regularly.
- [x] You are whitelisting your own tags or attributes in your XSS Prevention Settings.
- [x] You are using a deprecated custom HTML Header.
- [x] You are using the deprecated Twitter OAuth 2 Authentication.
