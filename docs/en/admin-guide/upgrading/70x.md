...
#### Automatic deletion of "untitled page"

The created "Untitled Page" will be automatically deleted after a certain period of time (48 hours by default) after creation.
However, if the page title has been changed, if there is a page body, or if it is not a WIP page, it will not be deleted.
...
- [x] About new page creation process and behavior changes, WIP pages
  - [x] Inform GROWI users about the change.
- [x] About automatic deletion of "untitled page"
  - [x] Inform GROWI users about the change.
