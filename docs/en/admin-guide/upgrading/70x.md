...
For an overview of the upgrade path, see [Upgrade Overview and Migration to the Latest Version](/en/admin-guide/upgrading/).
:::

::: warning
Versions from v6.1.0 through v7.0.15 contain a bug in the migration of Revision data.
