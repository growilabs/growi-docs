...
::: danger
The v7.0 series falls within the v6.1.0 - v7.0.15 range, which has a serious bug in Revision (page edit history) data. Do not upgrade to a version in that range; **upgrade directly to v7.4.0 or later**.
For details, see [Upgrade Overview and Migration to the Latest Version](/en/admin-guide/upgrading/).
:::
